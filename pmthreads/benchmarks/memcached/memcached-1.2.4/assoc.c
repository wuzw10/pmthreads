...
void assoc_init(void) {
    ...
    primary_hashtable = (item**)nvmalloc(hash_size, "primary_hashtable");
...
static void assoc_expand(void) {
    ...
    primary_hashtable = (item**)nvmalloc(hashsize(hashpower + 1) * sizeof(void *), "hashtable_expand");
	memset(primary_hashtable, 0, hashsize(hashpower + 1) * sizeof(void *));
#else
