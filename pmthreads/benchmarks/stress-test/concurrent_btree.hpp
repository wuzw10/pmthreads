...
#ifndef __concurrent_btree_hpp__
#define __concurrent_btree_hpp__
...
const int BTREE_PAGE_SIZE = PAGESIZE;
...
namespace concurrent{
    ...
    const int cardinality = (BTREE_PAGE_SIZE-sizeof(header))/sizeof(entry);
